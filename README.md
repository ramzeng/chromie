...
| 盈透证券 | [IB Gateway](https://ibkrcampus.com/campus/trading-lessons/installing-configuring-tws-for-the-api/)，模拟盘默认 `127.0.0.1:4002`（实盘 `4001`） | 证券持仓与分币种现金 |
...
欧易和币安账户可以分别跟随系统网络、强制直连，或使用可复用的远端代理配置。显式代理支持 HTTP、HTTPS、SOCKS5 和 SOCKS5H，并可使用用户名和密码认证。
